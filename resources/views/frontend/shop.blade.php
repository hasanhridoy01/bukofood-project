        	...
        	<div class="col-sm-12 text-center">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="https://bestwebcreator.com/organiq/demo/shop-four-columns.html#">Home</a></li>
                    <li class="breadcrumb-item"><a href="https://bestwebcreator.com/organiq/demo/shop-four-columns.html#">Shop</a></li>
                    ...
                    <div class="product_img">
                        ...
                        <div class="product_action_box">
                            <ul class="list_none pr_action_btn">
                                ...
                                <li><a href="" class="popup-ajax"><i class="ti-eye"></i></a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-12 mt-3 mt-lg-4">
                <ul class="pagination justify-content-center">
                    <li class="page-item disabled"><a class="page-link" href="https://bestwebcreator.com/organiq/demo/shop-four-columns.html#" tabindex="-1"><i class="ion-ios-arrow-thin-left"></i></a></li>
                    <li class="page-item active"><a class="page-link" href="https://bestwebcreator.com/organiq/demo/shop-four-columns.html#">1</a></li>
                    <li class="page-item"><a class="page-link" href="https://bestwebcreator.com/organiq/demo/shop-four-columns.html#">2</a></li>
                    <li class="page-item"><a class="page-link" href="https://bestwebcreator.com/organiq/demo/shop-four-columns.html#">3</a></li>
                    <li class="page-item"><a class="page-link" href="https://bestwebcreator.com/organiq/demo/shop-four-columns.html#"><i class="ion-ios-arrow-thin-right"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
