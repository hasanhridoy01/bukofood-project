            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <ul class="header_list border_list list_none header_dropdown text-center text-md-right">
                        ...
                        <li class="dropdown">
                          <a class="dropdown-toggle" href="https://bestwebcreator.com/organiq/demo/index.html#" data-toggle="dropdown">My Account</a>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg"> 
            <a class="navbar-brand" href="index.html">
                <img class="logo_light" src="frontend/./asset/img/boku_logo_new.png" alt="logo">
                <img class="logo_dark" src="frontend/./asset/img/boku_logo_new.png" alt="logo">
                <img class="logo_default" src="frontend/./asset/img/boku_logo_new.png" alt="logo">
            </a>
                ...
                <li class="dropdown cart_wrap">
                    <a class="nav-link" href="index.html#" data-toggle="dropdown"><i class="ion-bag"></i><span class="cart_count">2</span></a>
                        <div class="cart_box dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
                                <li>
                                    <a href="https://bestwebcreator.com/organiq/demo/index.html#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="https://bestwebcreator.com/organiq/demo/index.html#"><img src="frontend/./asset/img/cart_thamb1.jpg" alt="cart_thumb1">Fresh Organic Strawberry</a>
                                    <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span>78.00</span></span>
                                </li>
                                <li>
                                    <a href="https://bestwebcreator.com/organiq/demo/index.html#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="https://bestwebcreator.com/organiq/demo/index.html#"><img src="frontend/./asset/img/cart_thamb2.jpg" alt="cart_thumb2">Fresh Organic Grapes</a>
...
<!--section class="bg_light_yellow breadcrumb_section background_bg bg_fixed bg_size_contain" data-img-src="assets/images/breadcrumb_bg.png" style="background-image: url(&quot;assets/images/breadcrumb_bg.png&quot;); background-position: center center; background-size: cover;">
    <div class="container">
        <div class="row align-items-center">
                ...
                <div id="accordion" class="accordion">
                    <div class="card">
                      <div class="card-header" id="heading-One">
                        <h6 class="mb-0"> <a data-toggle="collapse" href="#collapse-One" aria-expanded="true" aria-controls="collapse-One">What is BokuFoods all about?</a> </h6>
                      </div>
                      <div id="collapse-One" class="collapse show" aria-labelledby="heading-One" data-parent="#accordion">
                        <div class="card-body">BOKUFoods is a direct marketing and distribution division of Agrobint with primary aim of marketing and distributing foods and agri products.
.</div>
                      </div>
                    </div>
                    <div class="card">
                      <div class="card-header" id="heading-Two">
                        <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapse-Two" aria-expanded="false" aria-controls="collapse-Two">Is it only agrobint foods?</a> </h6>
                      </div>
                      <div id="collapse-Two" class="collapse" aria-labelledby="heading-Two" data-parent="#accordion">
                        <div class="card-body"> No, BokuFoods have various agriFoods products. Farmers or SME who register with agrobint have the opportunity to sell their produce and products through BokuFoods network.</div>
                      </div>
                    </div>
                    <div class="card">
                      <div class="card-header" id="heading-Three">
                        <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapse-Three" aria-expanded="false" aria-controls="collapse-Three">Can I buy any food item on BookuFoods website?</a> </h6>
                      </div>
                      <div id="collapse-Three" class="collapse" aria-labelledby="heading-Three" data-parent="#accordion">
                        <div class="card-body">Yes, you can buy any products or agriFoods available on the website. BokuFoods aims to provide every foods items a household need. Members can also request for any foods or products not listed on the website and we will make it available. </div>
                      </div>
                    </div>
                    <div class="card">
                      <div class="card-header" id="heading-Four">
                        <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapse-Four" aria-expanded="false" aria-controls="collapse-Four">How does It work?</a> </h6>
                      </div>
                      <div id="collapse-Four" class="collapse" aria-labelledby="heading-Four" data-parent="#accordion">
                        <div class="card-body">BokuFoods is a member and subscription based platform aim at providing the best foods to its members for free using the bonus voucher members get when they invite other members.</div>
                      </div>
                    </div>
                    <div class="card">
                      <div class="card-header" id="heading-Five">
                        <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapse-Five" aria-expanded="false" aria-controls="collapse-Five">What is Bonus Voucher?</a> </h6>
                      </div>
                      <div id="collapse-Five" class="collapse" aria-labelledby="heading-Five" data-parent="#accordion">
                        <div class="card-body">BokuFoods bonus voucher is the reward or benefit members get when they invite other members. Members can use their bonus voucher to purchase any item on the website.  The bonus voucher can also be used to pay for food items at any approved supermarket registered with BokuFoods Nationwide. </div>
                      </div>
                    </div>
                    <div class="card">
                      <div class="card-header" id="heading-six">
                        <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapse-six" aria-expanded="false" aria-controls="collapse-six">Do you mean I can use my bonus to pay for foods at supermarket.?</a> </h6>
                      </div>
                      <div id="collapse-six" class="collapse" aria-labelledby="heading-six" data-parent="#accordion">
                        <div class="card-body">Yes, BokuFoods members enjoy lots of benefits. You can use your bonus to pay for food at any participating supermarket. </div>
                      </div>
                    </div>
              </div>
            </div>
