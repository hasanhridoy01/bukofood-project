                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $tag -> slug }}</td>
                                        <td>
                                            <a id="tag_edit" edit_id="{{ $tag -> id }}" class="btn  btn-warning btn-sm" href="#">Edit</a>
                                            <form style="display: inline;" action="{{ route('tag-add.destroy', $tag -> id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('tag-add.store') }}"  method="POST">
                            @csrf
        ...
        <div id="tag_modal_update" class="modal fade">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="tag_edit_id" action="{{ route('tag.update') }}"  method="POST">
                            @csrf
                            <div class="form-group">
                                <input name="name" class="form-control" type="text" placeholder="Name">
